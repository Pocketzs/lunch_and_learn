    ...
    it 'exists and has attributes' do
      ...
      recipe_data = 
      {
        ...
        :totalNutrients=>
          ...
          :FOLDFE=>{:label=>"Folate equivalent (total)", :quantity=>0.708738078125, :unit=>"µg"},
          :FOLFD=>{:label=>"Folate (food)", :quantity=>0.708738078125, :unit=>"µg"},
        ...
        :digest=>
          ...
          {:label=>"Vitamin A", :tag=>"VITA_RAE", :schemaOrgTag=>nil, :total=>0.0, :hasRDI=>true, :daily=>0.0, :unit=>"µg"},
          ...
          {:label=>"Folate equivalent (total)", :tag=>"FOLDFE", :schemaOrgTag=>nil, :total=>0.708738078125, :hasRDI=>true, :daily=>0.17718451953125, :unit=>"µg"},
          {:label=>"Folate (food)", :tag=>"FOLFD", :schemaOrgTag=>nil, :total=>0.708738078125, :hasRDI=>false, :daily=>0.0, :unit=>"µg"},
          {:label=>"Folic acid", :tag=>"FOLAC", :schemaOrgTag=>nil, :total=>0.0, :hasRDI=>false, :daily=>0.0, :unit=>"µg"},
          {:label=>"Vitamin B12", :tag=>"VITB12", :schemaOrgTag=>nil, :total=>0.0, :hasRDI=>true, :daily=>0.0, :unit=>"µg"},
          {:label=>"Vitamin D", :tag=>"VITD", :schemaOrgTag=>nil, :total=>0.0, :hasRDI=>true, :daily=>0.0, :unit=>"µg"},
          {:label=>"Vitamin E", :tag=>"TOCPHA", :schemaOrgTag=>nil, :total=>0.0, :hasRDI=>true, :daily=>0.0, :unit=>"mg"},
          {:label=>"Vitamin K", :tag=>"VITK1", :schemaOrgTag=>nil, :total=>0.0, :hasRDI=>true, :daily=>0.0, :unit=>"µg"},
